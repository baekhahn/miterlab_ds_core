...
const buildNode = (
  ...
  if (node.type === "component") {
    const rawSpec =
      node.component.toLowerCase() === "tab"
    ...
    const mapped = mapComponent({
      ...
      loading:
        node.props?.loading === true || node.props?.loading === false || node.props?.loading === "auto"
          ? node.props.loading
          : undefined,
      ...
      onCompositionStart:
        typeof node.props?.onCompositionStart === "string" ? node.props.onCompositionStart : undefined,
      onCompositionEnd:
        typeof node.props?.onCompositionEnd === "string" ? node.props.onCompositionEnd : undefined,
      ...
      onlyShowClearWhenFocus:
        typeof node.props?.onlyShowClearWhenFocus === "boolean" ? node.props.onlyShowClearWhenFocus : undefined,
      ...
      activeLineMode:
        node.props?.activeLineMode === "auto" || node.props?.activeLineMode === "full" || node.props?.activeLineMode === "fixed"
      ...
      layout:
        node.props?.layout === "vertical" || node.props?.layout === "horizontal" ? node.props.layout : undefined,
      ...
      arrowIcon:
        typeof node.props?.arrowIcon === "boolean" || typeof node.props?.arrowIcon === "string" ? node.props.arrowIcon : undefined,
      arrow:
        typeof node.props?.arrow === "boolean" || typeof node.props?.arrow === "string" ? node.props.arrow : undefined,
      ...
      position:
        node.props?.position === "top" || node.props?.position === "bottom" || node.props?.position === "left" || node.props?.position === "right" || node.props?.position === "center"
          ? node.props.position
          : undefined,
      ...
      icon:
        node.props?.icon === "success" || node.props?.icon === "fail" || node.props?.icon === "loading" || typeof node.props?.icon === "string"
          ? node.props.icon
          : undefined,
      ...
      backIcon:
        typeof node.props?.backIcon === "boolean" || typeof node.props?.backIcon === "string" ? node.props.backIcon : undefined,
      backArrow:
        typeof node.props?.backArrow === "boolean" || typeof node.props?.backArrow === "string" ? node.props.backArrow : undefined,
      ...
      childElementPosition:
        node.props?.childElementPosition === "normal" || node.props?.childElementPosition === "right"
      ...
      cssBackgroundColor:
        typeof node.props?.["--background-color"] === "string" ? node.props["--background-color"] : undefined,
      cssBorderRadius:
        typeof node.props?.["--border-radius"] === "string" ? node.props["--border-radius"] : undefined,
      cssBorderWidth:
        typeof node.props?.["--border-width"] === "string" ? node.props["--border-width"] : undefined,
      cssBorderStyle:
        typeof node.props?.["--border-style"] === "string" ? node.props["--border-style"] : undefined,
      cssBorderColor:
        typeof node.props?.["--border-color"] === "string" ? node.props["--border-color"] : undefined,
      cssFixedActiveLineWidth:
        typeof node.props?.["--fixed-active-line-width"] === "string" ? node.props["--fixed-active-line-width"] : undefined,
      cssActiveLineHeight:
        typeof node.props?.["--active-line-height"] === "string" ? node.props["--active-line-height"] : undefined,
      cssActiveLineBorderRadius:
        typeof node.props?.["--active-line-border-radius"] === "string"
          ? node.props["--active-line-border-radius"]
          : undefined,
      cssTitleFontSize:
        typeof node.props?.["--title-font-size"] === "string" ? node.props["--title-font-size"] : undefined,
      cssContentPadding:
        typeof node.props?.["--content-padding"] === "string" ? node.props["--content-padding"] : undefined,
      cssActiveTitleColor:
        typeof node.props?.["--active-title-color"] === "string" ? node.props["--active-title-color"] : undefined,
      cssActiveLineColor:
        typeof node.props?.["--active-line-color"] === "string" ? node.props["--active-line-color"] : undefined,
      cssActiveBackgroundColor:
        typeof node.props?.["--active-background-color"] === "string" ? node.props["--active-background-color"] : undefined,
      cssAlignItems:
        typeof node.props?.["--align-items"] === "string" ? node.props["--align-items"] : undefined,
      cssBorderBottom:
        typeof node.props?.["--border-bottom"] === "string" ? node.props["--border-bottom"] : undefined,
      cssBorderInner:
        typeof node.props?.["--border-inner"] === "string" ? node.props["--border-inner"] : undefined,
      cssBorderTop:
        typeof node.props?.["--border-top"] === "string" ? node.props["--border-top"] : undefined,
      cssExtraMaxWidth:
        typeof node.props?.["--extra-max-width"] === "string" ? node.props["--extra-max-width"] : undefined,
      cssFontSize:
        typeof node.props?.["--font-size"] === "string" ? node.props["--font-size"] : undefined,
      cssHeaderFontSize:
        typeof node.props?.["--header-font-size"] === "string" ? node.props["--header-font-size"] : undefined,
      cssPaddingLeft:
        typeof node.props?.["--padding-left"] === "string" ? node.props["--padding-left"] : undefined,
      cssPaddingRight:
        typeof node.props?.["--padding-right"] === "string" ? node.props["--padding-right"] : undefined,
      cssPrefixPaddingRight:
        typeof node.props?.["--prefix-padding-right"] === "string" ? node.props["--prefix-padding-right"] : undefined,
      cssPrefixWidth:
        typeof node.props?.["--prefix-width"] === "string" ? node.props["--prefix-width"] : undefined,
      cssHeight:
        typeof node.props?.["--height"] === "string" ? node.props["--height"] : undefined,
      cssZIndex:
        typeof node.props?.["--z-index"] === "string" ? node.props["--z-index"] : undefined,
      cssMaxWidth:
        typeof node.props?.["--max-width"] === "string" ? node.props["--max-width"] : undefined,
      cssMinWidth:
        typeof node.props?.["--min-width"] === "string" ? node.props["--min-width"] : undefined,
      iconPosition:
        node.props?.iconPosition === "left" || node.props?.iconPosition === "right"
