...
import type { EvaluationInput, EvaluationIssue, ScreenEvaluationResult } from "./types";

const unique = (items: string[]): string[] => [...new Set(items)];

const collectAffected = (issues: EvaluationIssue[]) => {
...
export const evaluateScreen = (input: EvaluationInput): ScreenEvaluationResult => {
