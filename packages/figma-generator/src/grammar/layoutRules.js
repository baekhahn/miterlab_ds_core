...
export const layoutRules = {
    sectionOrderFallback: ["header", "filter", "content", "form", "list", "detail", "action", "footer", "empty", "modal"],
    sectionSpacing: {
    ...
    componentDefaults: {
        input: { width: 358, height: 48 },
        textarea: { width: 358, height: 96 },
        select: { width: 358, height: 40 },
        "check-mark": { width: 24, height: 24 },
        checkbox: { width: 358, height: 44 },
        radio: { width: 358, height: 44 },
        switch: { width: 358, height: 44 },
        ...
        autocomplete: { width: 358, height: 48 },
        "text-field": { width: 358, height: 48 },
        "text-area": { width: 358, height: 96 },
        "search-field": { width: 358, height: 48 },
